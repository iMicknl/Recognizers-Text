...
namespace Microsoft.Recognizers.Definitions.Dutch
{
	...
	public static class DateTimeDefinitions
	{
		...
		public const string AmRegex = @"(?<am>((at|in|around|on|for)\s+(the\s+)?)?(morgen))";
		...
		public static readonly string WrittenTimeRegex = $@"(?<writtentime>{MinuteNumRegex}\s+(over|voor)\s+({HourNumRegex}|{HourNumRegex}\s+({MinuteNumRegex}|(?<tens>twenty|thirty|forty|fourty|fifty)\s+{MinuteNumRegex}))";
